...
export class TasksService implements ITasksService {
    ...
    async createTask({ title, description, status }: CreateTaskDto): Promise<Partial<Task>> {
    ...
    async updateTask(id: number, { title, description, status }: UpdateTaskDto): Promise<Partial<Task>> {
